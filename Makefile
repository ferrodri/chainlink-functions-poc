...
# Example on how to run this command: "make deploy-anvil contract=GettingStartedFunctionsConsumer", remember to first run "make anvil"
...
# Example on how to run this command: "make deploy-mumbai contract=GettingStartedFunctionsConsumer"
...
deploy-all :; make deploy-${network} contract=GettingStartedFunctionsConsumer
